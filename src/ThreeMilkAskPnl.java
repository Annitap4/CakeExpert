...
public class ThreeMilkAskPnl extends JPanel {
	...
	private void initGUI() {
		...
		JLabel img1 = new JLabel(new ImageIcon(getClass().getResource("/images/slide3.png")));
		...
		JLabel img2 = new JLabel(new ImageIcon(getClass().getResource("/images/slide4.png")));
		gbc = new GridBagConstraints();
		gbc.gridx = 2; 
		gbc.gridy = 0; 
		gbc.gridwidth = 1; 
		...
		r1 = new JRadioButton("...no tener leche evaporada a la mano");
		...
		l1 = new JTextArea();
		l1.setText("- Ésta se puede sustituir con 10 cucharadas de leche \ncompleta en polvo");
		...
		r3 = new JRadioButton("...las claras de huevo no quedan a punto de nieve");
		...
		l3.setText("- Agregar mas azúcar y seguir batiendo, si la mezcla no \nmejora, desechar y comenzar de nuevo");
		l3.setVisible(false);
		gbc = new GridBagConstraints();
		gbc.gridx = 1; 
		gbc.gridy = 7; 
		...
		r4 = new JRadioButton("...alguna de las leches está en mal estado");
		...
		l4 = new JTextArea();
		l4.setText("- Si no se ha incorporado a la mezcla, sustituirla por otra, \nsi ya se mezcló con las otras leches, puede optar hacer yogurt \ncon estas");
		l4.setVisible(false);
