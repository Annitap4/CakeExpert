...
public class MainPnl extends JPanel {
	...
	private void initGUI() {
		...
		JLabel txtLbl = new JLabel("Que torta desea?");
		...
		JButton btnThreeMilk = new JButton("Torta 3 Leches", new ImageIcon(getClass().getResource("images/bread.png")));
		...
		JButton btnChocolate = new JButton("Torta de Chocolate", new ImageIcon(getClass().getResource("images/bread.png")));
		...
		JButton btnPumpkin = new JButton("Torta de Auyama", new ImageIcon(getClass().getResource("images/bread.png")));
		...
		JButton btnHomeMade = new JButton("Torta Casera", new ImageIcon(getClass().getResource("images/bread.png")));
		...
		JButton btnPineApple = new JButton("Torta de Piña", new ImageIcon(getClass().getResource("images/bread.png")));
